...
export default props => {
    ...
    let sortedSurfSpotsWaveHeight = surfspots;
    sortedSurfSpotsWaveHeight.sort(function(a, b) {
        if(a.waveHeight < b.waveHeight) return 1;
        if(a.waveHeight > b.waveHeight) return -1;
        return 0;
    });
    ...
    return (
        <div class="tableMain">
                    <h5 id="waveHeight">Wave Height</h5>
                    <table className="table table-bordered">
                        ...
                        {sortedSurfSpotsWaveHeight && sortedSurfSpotsWaveHeight.slice(0, 5).map((surfspot, idx)=>
                        <tr key={idx}>
                            <td>
