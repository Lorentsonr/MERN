...
export default props => {
    ...
    let sortedSurfSpotsWindSpeed = surfspots;
    sortedSurfSpotsWindSpeed.sort(function(a, b) {
        if(a.windSpeed < b.windSpeed) return 1;
        if(a.windSpeed > b.windSpeed) return -1;
        return 0;
    });
    ...
    return (
        <div class="tableMain">
                    ...
                    <table className="table table-bordered">
                        ...
                        {sortedSurfSpotsWindSpeed && sortedSurfSpotsWindSpeed.slice(0, 5).map((surfspot, idx)=>
                        <tr key={idx}>
                            <td>
